	...
	<div class="row">
		<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
			<div class="card card-signin my-5">
				<div class="card-body">
					<h5 id="home-form-desc" class="card-title text-center">Invalid verification code.</h5>
					<form class="form-signin">
						<button class="btn btn-lg btn-danger btn-block text-uppercase"><a href="<?php echo base_url(); ?>" style="color: white;">GO BACK</a></button>
					</form>
				</div>
			</div>
		</div>
